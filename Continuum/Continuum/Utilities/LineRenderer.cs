...
namespace Continuum.Utilities
{
    public class LineRenderer
    {
        ...
        {
            Vector2 difference = point2 - point1; float length = difference.Length(); float angle = (float)Math.Atan2(difference.Y, difference.X); spriteBatch.Draw(lineTexture, point1, null, color, angle,
            new Vector2(0, 1),
